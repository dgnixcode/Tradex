...
export async function run(assert) {
  ...
  const ALLOWED = ['/group-trades', '/groups', '/assets', '/accounts', '/login', '/signup', '/logout', '/session', '/trading', '/auth', '/account', '/audit', '/positions', '/blotter', '/analytics', '/settings', '/futures', '/market-price'];
